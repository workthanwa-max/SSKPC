...
# สำหรับการพัฒนาระบบหรือทดสอบ (สร้างทั้งบัญชีและข้อมูลจำลองทั้งหมด):
npm run seed

# สำหรับระบบ Production (บังคับรัน เพื่อสร้างหมวดหมู่ปัจจัย 4 พื้นฐานและบัญชีหลัก):
npm run seed:prod
...
หากคุณรัน `npm run seed` แล้ว สามารถล็อกอินด้วยบัญชีต่อไปนี้ (รหัสผ่านเหมือนกันทั้งหมด):
